...
tags:
  ...
  - 运维技巧
draft: false
aiSummary: "在使用rsync进行文件同步时，每次都需要输入密码确实很麻烦。本文将介绍如何配置rsync实现免密登录，提高工作效率。"
aiKeyPoints:
  - "为什么需要免密登录？"
  - "实现免密登录的方法"
  - "1. 使用SSH密钥对"
faq:
  - q: "这篇文章讲什么？"
    a: "在使用rsync进行文件同步时，每次都需要输入密码确实很麻烦。本文将介绍如何配置rsync实现免密登录，提高工作效率。"
  - q: "适合谁阅读？"
    a: "适合关注“使用rsync时怎么才能不用输入密码”相关主题的读者。"
---
