...
draft: false
aiSummary: "n8n 作为开源自动化平台，其强大之处在于丰富的内置节点（Built-in Nodes）体系。本文将系统梳理 n8n 内置节点的类型、功能与典型应用场景，帮助你高效构建自动化工作流。"
aiKeyPoints:
  - "n8n 内置节点类型概览"
...
faq:
  - q: "这篇文章讲什么？"
    a: "n8n 作为开源自动化平台，其强大之处在于丰富的内置节点（Built-in Nodes）体系。本文将系统梳理 n8n 内置节点的类型、功能与典型应用场景，帮助你高效构建自动化工作流。"
  - q: "适合谁阅读？"
    a: "适合关注“n8n内置节点类型详解与应用实践”相关主题的读者。"
---
