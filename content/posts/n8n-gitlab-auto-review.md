...
# nolastmod: true
draft: false
aiSummary: "本文介绍了一个基于 N8N 的自动化 GitLab 代码评审工作流，帮助开发团队实现高效、智能的代码审查流程。"
aiKeyPoints:
  - "工作流简介"
  - "核心流程"
  - "主要节点说明"
faq:
  - q: "这篇文章讲什么？"
    a: "本文介绍了一个基于 N8N 的自动化 GitLab 代码评审工作流，帮助开发团队实现高效、智能的代码审查流程。"
  - q: "适合谁阅读？"
    a: "适合关注“让AI帮你审代码！N8N+GitLab自动化智能评审全流程实战”相关主题的读者。"
---
