...
# nolastmod: true
draft: false
aiSummary: "FFmpeg是一个强大的开源工具，可以用来录制、转换和流化音频和视频。在本文中，我们将学习如何使用FFmpeg将一系列png图片转换成视频文件。"
aiKeyPoints:
  - "安装FFmpeg"
  - "准备图片"
  - "使用FFmpeg将png图片转换成视频"
faq:
  - q: "这篇文章讲什么？"
    a: "FFmpeg是一个强大的开源工具，可以用来录制、转换和流化音频和视频。在本文中，我们将学习如何使用FFmpeg将一系列png图片转换成视频文件。"
  - q: "适合谁阅读？"
    a: "适合关注“如何使用ffmpeg将png图片转换成视频”相关主题的读者。"
---
