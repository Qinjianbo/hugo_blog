...
tags:
  ...
  - 数据处理
  - 工作流
aiSummary: "在 n8n 工作流中，Merge 节点是实现数据流合并与处理的核心工具。它可以将来自不同节点的数据流进行多种方式的合并，极大提升了数据处理的灵活性。本文将详细介绍 Merge 节点的功能、常用模式及实际应用场景。"
aiKeyPoints:
  - "节点概述"
  - "主要合并模式"
  - "1. 追加（Append）"
faq:
  - q: "What is this article about?"
    a: "在 n8n 工作流中，Merge 节点是实现数据流合并与处理的核心工具。它可以将来自不同节点的数据流进行多种方式的合并，极大提升了数据处理的灵活性。本文将详细介绍 Merge 节点的功能、常用模式及实际应用场景。"
  - q: "Who is this for?"
    a: "For readers interested in N8n Merge 节点详解."
---
