...
tags:
  ...
  - 自动化
  - 教程
aiSummary: "本文将带你通过 n8n 官方教程，快速上手构建一个迷你自动化工作流。你将学会如何用 n8n 获取 Hacker News 上关于\"automation\"的10条最新资讯，并掌握节点配置、执行与保存的完整流程。"
aiKeyPoints:
  - "教程目标"
  - "步骤详解"
...
faq:
  - q: "这篇文章讲什么？"
    a: "本文将带你通过 n8n 官方教程，快速上手构建一个迷你自动化工作流。你将学会如何用 n8n 获取 Hacker News 上关于\"automation\"的10条最新资讯，并掌握节点配置、执行与保存的完整流程。"
  - q: "适合谁阅读？"
    a: "适合关注“n8n官方教程：构建一个迷你工作流实战”相关主题的读者。"
---
