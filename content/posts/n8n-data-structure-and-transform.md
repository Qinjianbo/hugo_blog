...
tags:
  ...
  - 数据转换
  - 教程
aiSummary: "本文基于 n8n 官方 Level Two 教程，系统讲解 n8n 的数据结构、Code 节点的用法，以及常见的数据转换技巧。适合希望深入理解 n8n 数据流和自动化处理的用户。"
aiKeyPoints:
  - "n8n 数据结构基础"
  - "Code 节点创建数据集"
  - "Code 节点引用上游数据"
faq:
  - q: "这篇文章讲什么？"
    a: "本文基于 n8n 官方 Level Two 教程，系统讲解 n8n 的数据结构、Code 节点的用法，以及常见的数据转换技巧。适合希望深入理解 n8n 数据流和自动化处理的用户。"
  - q: "适合谁阅读？"
    a: "适合关注“n8n官方教程：数据结构与数据转换实战”相关主题的读者。"
---
