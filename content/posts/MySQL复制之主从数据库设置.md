...
# nolastmod: true
draft: false
aiSummary: "最近又自己弄了台小服务器，学习了下mysql的主从数据库配置，记录一下配置过程，其实是mariadb的，但是应该都差不多。整个过程配置起来还是比较简单的，没有遇到什么坑，嘿嘿！"
aiKeyPoints:
  - "最近又自己弄了台小服务器，学习了下mysql的主从数据库配置，记录一下配置过程，其实是mariadb的，但是应该都差不多"
  - "整个过程配置起来还是比较简单的，没有遇到什么坑，嘿嘿！"
faq:
  - q: "这篇文章讲什么？"
    a: "最近又自己弄了台小服务器，学习了下mysql的主从数据库配置，记录一下配置过程，其实是mariadb的，但是应该都差不多。整个过程配置起来还是比较简单的，没有遇到什么坑，嘿嘿！"
  - q: "适合谁阅读？"
    a: "适合关注“MySQL复制之主从数据库设置”相关主题的读者。"
---
